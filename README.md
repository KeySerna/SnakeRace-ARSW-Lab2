...
- `Snake`: acceso al cuerpo (`ArrayDeque`) sincronizado con el monitor de la propia instancia (antes era leído por la UI y escrito por el hilo de la serpiente sin ningún candado).
